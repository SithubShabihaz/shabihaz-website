    ...
    <section className="w-full bg-black py-16">
      ...
      */}
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bordered Container */}
        <div className="w-full bg-black border mb-30 border-white/20 rounded-3xl p-8 md:p-12 lg:p-16 shadow-lg flex flex-col items-center justify-center">
          ...
          <div className="max-w-3xl text-center space-y-6 flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 w-full sm:w-auto">
              <Link 
                href="https://calendly.com/shabihazofficial/discovery-call" // 🔥 Yahan apna booking/Calendly link laga dein
